/* src/config/vrc-config.h.  Generated from vrc-config.h.in by configure.  */
/* src/config/vrc-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "vrc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "vrc Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vrc"
