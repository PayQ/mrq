...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a vrq address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vrq: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About vrq"), this);
    aboutAction->setStatusTip(tr("Show information about vrq"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for vrq"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your vrq addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified vrq addresses"));
    ...
    openAction->setStatusTip(tr("Open a vrq: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the vrq help message to get a list with possible vrq command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("vrq client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to vrq network", "", count));
}
...
{
    QString strTitle = tr("vrq"); // default title
