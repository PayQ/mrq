...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a vrc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vrc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About vrc"), this);
    aboutAction->setStatusTip(tr("Show information about vrc"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for vrc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your vrc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified vrc addresses"));
    ...
    openAction->setStatusTip(tr("Open a vrc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the vrc help message to get a list with possible vrc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("vrc client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to vrc network", "", count));
}
...
{
    QString strTitle = tr("vrc"); // default title
