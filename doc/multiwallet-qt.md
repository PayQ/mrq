...
In order to support loading of multiple wallets in vrq-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vrq.cpp.
...
Changes to vrq.cpp
----------------------
vrq.cpp is the entry point into vrq-qt, and as such, will require some minor modifications to provide hooks for
