...
In order to support loading of multiple wallets in vrc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vrc.cpp.
...
Changes to vrc.cpp
----------------------
vrc.cpp is the entry point into vrc-qt, and as such, will require some minor modifications to provide hooks for
