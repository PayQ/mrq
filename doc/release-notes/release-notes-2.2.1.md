vrq version 2.2.1 is now available from:
...
vrq is extensively tested on multiple operating systems using
...
vrq should also work on most other Unix-like systems but is not
...
of Bitcoin that vrq was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/vrqcoin-translations/).
