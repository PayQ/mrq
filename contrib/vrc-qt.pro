...
RESOURCES += src/qt/vrc.qrc src/qt/vrc_locale.qrc

TRANSLATIONS += src/qt/locale/vrc_bg.ts \
                src/qt/locale/vrc_de.ts \
                src/qt/locale/vrc_en.ts \
                src/qt/locale/vrc_es.ts \
                src/qt/locale/vrc_fi.ts \
                src/qt/locale/vrc_fr.ts \
                src/qt/locale/vrc_it.ts \
                src/qt/locale/vrc_ja.ts \
                src/qt/locale/vrc_pl.ts \
                src/qt/locale/vrc_pt.ts \
                src/qt/locale/vrc_ru.ts \
                src/qt/locale/vrc_sk.ts \
                src/qt/locale/vrc_sv.ts \
                src/qt/locale/vrc_vi.ts \
                src/qt/locale/vrc_zh_CN.ts \
                src/qt/locale/vrc_zh_TW.ts
