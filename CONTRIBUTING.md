...
The vrq project operates an open contributor model where anyone is
...
The following applies to code changes to the vrq project, and is not to be
confused with overall vrq Network Protocol consensus changes.

Whether a pull request is merged into vrq rests with the project merge
...
Patches that change vrq consensus rules are considerably more involved than
...
Where a patch set proposes to change the vrq consensus, it must have been
...
The project leader is the release manager for each vrq release.
