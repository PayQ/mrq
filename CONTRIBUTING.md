...
The vrc project operates an open contributor model where anyone is
...
The following applies to code changes to the vrc project, and is not to be
confused with overall vrc Network Protocol consensus changes.

Whether a pull request is merged into vrc rests with the project merge
...
Patches that change vrc consensus rules are considerably more involved than
...
Where a patch set proposes to change the vrc consensus, it must have been
...
The project leader is the release manager for each vrc release.
